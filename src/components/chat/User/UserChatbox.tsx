...
const AdminChatbox = ({
  ...
  return (
    <>
        <div className=" overflow-y-auto w-full bg-white border-none h-[28rem] px-2">
          ...
          <header className="py-2 px-2 items-center border-b-2 border-gray-300">
            <div className="flex flex-col items-center">
              ...
              <img
                ...
                alt="Chat Avatar"
              />
              <GoDotFill color={`${isUserOnline(recipientId) ? "green" : "yellow"}`} size={20} /> 
              </div>
          ...
          <div
            className="overflow-y-auto px-6 pb-6 h-[68%] "
                    ...
                    <div key={index} className="">
                      ...
                      {!isSender && (
                        <div className="mt-3 flex justify-start relative">
                          ...
                          <img
                            className=" absolute bottom-0 -left-[5px] w-4 h-3"
                            src={chatTailTwo}
                          />
                        </div>
                      )}
          ...
          <div className="mt-0 border-t-2 border-gray-200 ">
            <div className="relative flex items-center justify-between gap-3 p-2 mt-1 ">
              ...
              <textarea
                ...
                rows={1} // Set the number of rows to 2 for multiline input
                style={{ resize: "none" }} // Prevent resizing by user
              />
              ...
              {emojiPickerState && (
                <div
                  ref={emojiPickerRef}
                  className=" absolute right-0 w-9/10 h-[80%]  -top-[24rem]"
                >
                  <EmojiPicker
                    width="100%"
                    height={380}
